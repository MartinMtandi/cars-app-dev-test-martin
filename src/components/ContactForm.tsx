...
const ContactForm = ({ dealerName = '', dealerPhone = '', dealerEmail = '', vehicleTitle = '' }: ContactFormProps) => {
  ...
  return (
    <FormContainer>
      <FormTitle>
        <span>Contact {dealerName || 'Dealer'}</span>
      </FormTitle>
      
      <ContactDetails>
        <ContactItem>
          <ContactLabel>Phone:</ContactLabel>
          <Value>{formatPhoneNumber(dealerPhone)}</Value>
        </ContactItem>
        <ContactItem>
          <ContactLabel>Email:</ContactLabel>
          <Value>{formatEmail(dealerEmail)}</Value>
        </ContactItem>
      </ContactDetails>
